	...
	tables:
	{
		...
		prs:
		{
			...
			[
				...
				{ text: theUILang.DL, 			width: "70px", 	id: "dl",		type: TYPE_NUMBER },
				{ text: theUILang.UL, 			width: "70px", 	id: "ul",		type: TYPE_NUMBER },
                                { text: theUILang.PeerDL, 		width: "90px", 	id: "peerdl",		type: TYPE_NUMBER },
                                { text: theUILang.PeerDownloaded, 	width: "90px",  id: "peerdownloaded",	type: TYPE_NUMBER },
                                { text: 'ASN', 				width: "250px", id: "asn",		type: TYPE_STRING },
